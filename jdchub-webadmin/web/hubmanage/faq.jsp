...
<%
    ...
    String faq = AdcUtils.fromAdcString(textDataDAO.getData("FAQ", configInstance.getString(ConfigurationManager.HUB_DEFAULT_LOCALE)));
    List<String> list = textDataDAO.getLocales("FAQ");
...
<div class="content" align="center">
    <form action="faq.jsp" method="post" enctype="application/x-www-form-urlencoded">
