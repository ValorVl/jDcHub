package ru.sincore.tth;

import java.io.Serializable;
import java.security.DigestException;
import java.security.MessageDigest;

public class Tiger extends MessageDigest implements Cloneable, Serializable
{

    private static final long serialVersionUID = 5999517969048491681L;
     ...
     * output buffer when computing multiple digests. Overrides the protected
    ...
    /**
     * Reset then initialize the digest context. Overrides the protected
     * abstract method of <code>java.security.MessageDigestSpi</code>.
     */
     ...
     * and may be slow. Overrides the protected abstract method of
     ...
     * specified offset. Input length can be any size. May require internal
     * buffering, if input blocks are not multiple of 64 bytes. Overrides the
     ...
     * specification. For faster operations with multiple digests, allocate your
     * own array and use engineDigest(byte[], int offset, int len). * Overrides
     * the protected abstract method of java.security.MessageDigestSpi.
     *
     ...
     * automatically reset (see engineReset). Overrides the protected abstract
    ...
    /**
     * Updates the digest using the specified array of bytes, starting at the
     * specified offset, but an implied length of exactly 64 bytes. Requires no
     * internal buffering, but assumes a fixed input size, in which the required
    ...
    private void computeBlock(final byte[] input, int offset)
    {
        ...
        c = hC
            ^ (w0 = ((long) ((input[offset] & 0xff)
                    ...
                    | ((long) ((input[offset + 4] & 0xff)
                               ...
                               | ((input[offset + 1] & 0xff) << 16) | (input[offset + 2] << 24)) <<
                       32));
        a = (hA - (S0[(lo = (int) c) & 0xff] ^ S1[(lo >>> 16) & 0xff]
                   ^ S2[(hi = (int) (c >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
            ^ (w1 = ((long) ((input[offset + 3] & 0xff)
                             | ((input[offset + 4] & 0xff) << 8)
                             | ((input[offset += 5] & 0xff) << 16) | (input[offset + 1] << 24)) &
                     0xffffffffL)
                    | ((long) ((input[offset + 2] & 0xff)
                               | ((input[offset + 3] & 0xff) << 8)
                               | ((input[offset + 4] & 0xff) << 16) | (input[offset += 5] << 24)) <<
                       32));
        b = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) +
              hB) * 5 - (S0[(lo = (int) a) & 0xff]
                         ^
                         S1[(lo >>> 16) & 0xff] ^
                         S2[(hi = (int) (a >>> 32)) & 0xff] ^
                         S3[(hi >>> 16) & 0xff]))
            ^ (w2 = ((long) ((input[offset + 1] & 0xff)
                             ...
                             | ((input[offset + 3] & 0xff) << 16) | (input[offset + 4] << 24)) &
                     0xffffffffL)
                    | ((long) ((input[offset += 5] & 0xff)
                               | ((input[offset + 1] & 0xff) << 8)
                               | ((input[offset + 2] & 0xff) << 16) | (input[offset + 3] << 24)) <<
                       32));
        c = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) +
              c) * 5 - (S0[(lo = (int) b) & 0xff]
                        ^
                        S1[(lo >>> 16) & 0xff] ^
                        S2[(hi = (int) (b >>> 32)) & 0xff] ^
                        S3[(hi >>> 16) & 0xff]))
            ^ (w3 = ((long) ((input[offset + 4] & 0xff)
                    ...
                    | ((long) ((input[offset + 3] & 0xff)
                               ...
                               | ((input[offset += 5] & 0xff) << 16) | (input[offset + 1] << 24)) <<
                       32));
        a = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) +
              a) * 5 - (S0[(lo = (int) c) & 0xff]
                        ^
                        S1[(lo >>> 16) & 0xff] ^
                        S2[(hi = (int) (c >>> 32)) & 0xff] ^
                        S3[(hi >>> 16) & 0xff]))
       ...
       */
        ...
        hA ^= ((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) +
               a) * 9;
    }
