...
import ru.sincore.adc.action.actions.RNT;
 ...
 * @since 2012-06-26
 */
public class RNTHandler extends AbstractActionHandler<RNT>
{
    private static final Logger log = LoggerFactory.getLogger(RNTHandler.class);


    public RNTHandler(AbstractClient sourceClient, RNT action)
    {
